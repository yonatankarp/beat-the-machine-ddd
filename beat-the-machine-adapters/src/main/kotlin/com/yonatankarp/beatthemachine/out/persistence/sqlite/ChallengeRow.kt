...
/**
 * Plain data class used as the persistence mapping layer between the database
 * and the domain [Challenge][com.yonatankarp.beatthemachine.domain.Challenge].
 * The domain type is never annotated; this class is consumed only by the
 * [SqliteChallengeRepository] RowMapper.
 *
